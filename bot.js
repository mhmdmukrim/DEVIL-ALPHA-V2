                            ...
                            if (config.LANG == 'SI') {
                                ...
                                if (error.message.includes('URL')) {
                                    ...
                                    return await DevilAlphaCon.sendMessage(DevilAlphaCon.user.jid, '*⚜️ ERROR ANALYSIS [DEVIL ALPHA] ⚜️*' + 
                                        ...
                                        '\n\n*Reason:* _DevilAlphaConection between site disDevilAlphaConected._' +
                                    ...
                                    return await DevilAlphaCon.sendMessage(DevilAlphaCon.user.jid, '*🙇🏻 Sorry, I Couldnt Read This Error! 🙇🏻*' +
