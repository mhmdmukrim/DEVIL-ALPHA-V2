...
module.exports = {
    VERSION: 'v7.3.6',
    CHANNEL: 'https://t.me/joinchat/3QPcpYgZG2w2ZDY1',
    SESSION: process.env.DEVIL_SESSION === undefined ? '' : process.env.DEVIL_SESSION,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === hizliresimundefined ? 'false' : process.env.AUTO_BİO,
    THERI_KICK: process.env.THERI_KICK === undefined ? 'false' : process.env.THERI_KICK,
    AFN: process.env.ALL_CAPTION === undefined ? 'public bot mukki' : process.env.ALL_CAPTION,
    ALL_LINK_BAN: process.env.ALL_LINK_BAN === undefined ? 'false' : process.env.ALL_LINK_BAN,
    MUKKI: process.env.OWNER_NAME === undefined ? 'default' : process.env.OWNER_NAME,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.ibb.co/FgMW7h5/4566578.jpg' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'TR' : process.env.LANGUAGE.toUpperCase(),
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    MUKKI: process.env.TAG_REPLY === undefined ? '94766395983@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    MKMBGM: process.env.CHANGE_BGM_TO === undefined ? 'one' : process.env.CHANGE_BGM_TO,
